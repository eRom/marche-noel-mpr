...
export function GalleryUpload({ password }: GalleryUploadProps) {
  ...
  const canUpload =
    file && file.status === "pending" && title.trim().length > 0;
    ...
    <div className="space-y-6">
      ...
      {!file && !isProcessing && (
        ...
        >
          ...
          >
            <span className="font-semibold text-gray-900 hover:text-gray-700 dark:text-gray-100 dark:hover:text-gray-300">
          ...
          <div className="group relative overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800">
            <div className="relative aspect-video">
              ...
              {file.status === "pending" && (
                <button
                  onClick={removeFile}
                  className="absolute top-4 right-4 z-10 rounded-full bg-gray-900 p-2 text-white opacity-0 transition-opacity group-hover:opacity-100 dark:bg-gray-800"
