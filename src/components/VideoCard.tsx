...
export function VideoCard({ src, title, description }: VideoCardProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-card rounded-lg border border-border overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      <div className="relative aspect-video max-h-[300px] bg-foreground/10">
        <video
          ref={videoRef}
          src={src}
          muted
