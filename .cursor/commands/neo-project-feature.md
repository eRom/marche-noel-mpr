...
1. **Analyze the existing codebase** to understand:
   ...
   - The codebase source
2. **Understand the feature** to implement
   - Read the file in argument[feature]
3. **Think deeply and create a comprehensive implementation plan**
...
4. **Ask clarifying questions** if anything is unclear or ambiguous about:
...
5. Plan at the beginning to **Create a Git branch** : use command `.cursor/commands/neo-git-branch`
