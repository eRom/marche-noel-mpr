...
**Sortie :** `reports/eslint-a11y-report.json` avec la liste des problèmes détectés.
...
**Sortie :** `reports/axe-report.json` avec la liste des problèmes détectés.
...
**Sortie :** `reports/lighthouse-report.json` avec score global et détails des vérifications.
